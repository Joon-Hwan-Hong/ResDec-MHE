...
class TestSave:
    ...
    def test_save_creates_files(self, basic_analyzer, tmp_path):
        ...
        saved = basic_analyzer.save(result, tmp_path)
        assert (tmp_path / "cluster_assignments.parquet").exists()
        assert (tmp_path / "outlier_scores.csv").exists()
        assert (tmp_path / "trajectory_scores.parquet").exists()
...
class TestConvenienceFunction:
    ...
    def test_analyze_embeddings_with_output_dir(self, sample_embeddings, sample_subject_ids, tmp_path):
