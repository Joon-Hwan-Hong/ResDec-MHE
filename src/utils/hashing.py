...
def generate_experiment_hash(config: dict[str, Any]) -> str:
    ...
    Example: 20260113_143052_123456_a3f7b2c1e9d4f5...
             20260113_143052_123456_baseline-5fold_a3f7b2c1e9d4f5...
    ...
    if run_name:
        ...
        return f"{timestamp}_{safe_name}_{full_hash}"

    return f"{timestamp}_{full_hash}"
