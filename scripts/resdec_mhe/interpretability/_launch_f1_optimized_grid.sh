...
PID0_5_ABS=$!
wait "$PID0_5_REL" || echo "[f1_opt_grid] GPU0 rel-0.5 failed (pid $PID0_5_REL)"
wait "$PID0_5_ABS" || echo "[f1_opt_grid] GPU1 abs-0.5 failed (pid $PID0_5_ABS)"
...
PID0_3_ABS=$!
wait "$PID0_3_REL" || echo "[f1_opt_grid] GPU0 rel-0.3 failed (pid $PID0_3_REL)"
wait "$PID0_3_ABS" || echo "[f1_opt_grid] GPU1 abs-0.3 failed (pid $PID0_3_ABS)"
